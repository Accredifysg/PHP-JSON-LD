...
- [~] Compaction (§5.6) — implemented incl. container-maps, keyword recursion, `@nest`, `@graph` maps, `@reverse`, value-aware term selection, property-scoped contexts; ~172/246 of the W3C compact suite
