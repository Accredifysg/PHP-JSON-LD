...
- [~] Expansion (§5.5) — implemented; ~329/385 of the W3C expand suite
...
- [~] Serialize JSON-LD to RDF (§7 / `toRdf`) — implemented; ~408/467 of the W3C toRdf suite (N-Quads output incl. `rdfDirection`; generalized RDF pending)
