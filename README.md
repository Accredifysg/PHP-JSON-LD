...
- [~] Expansion (§5.5) — implemented; ~362/385 of the W3C expand suite
...
- [~] Serialize JSON-LD to RDF (§7 / `toRdf`) — implemented; ~431/467 of the W3C toRdf suite (N-Quads output incl. `rdfDirection`; generalized RDF pending)
